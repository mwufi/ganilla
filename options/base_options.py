...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', required=False, default="../dataset/photo2axel/", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        # parser.add_argument('--dataroot', required=False, default="../dataset/cityscapes_pix2pix", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        # parser.add_argument('--dataroot', required=False, default="../dataset/test/SUN/test_cartoon2", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='../checkpoints/GANILLA', help='models are saved here')
